...
public class HomeResourceInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object o) throws IOException {
        ...
        siteBasicStatistics.add(articleService.countArticle(EnArticleStatus.PUBLISH.getValue()) + "");
        ...
        siteBasicStatistics.add(linkService.countLink(EnLinkStatus.NORMAL.getValue()) + "");
